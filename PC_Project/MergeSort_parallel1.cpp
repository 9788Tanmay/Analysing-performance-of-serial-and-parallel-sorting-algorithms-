...
int main() {
  ...
  b = (int*) malloc(elements*sizeof(int));
  ...
  cout<<"Time taken for sorting of "<<elements<<" elements with parallel mergesort is: "<<(stopTime-startTime)/CLOCKS_PER_SEC<<endl;
  free(a);
  free(b);
